...
```
https://dextools-weso-adapter.vercel.app
```

All paths below are relative to that API base (e.g. `GET https://dextools-weso-adapter.vercel.app/latest-block`).

**Stable docs URLs:**
- Hosted: `https://dextools-weso-adapter.vercel.app/docs/ADAPTER.md`
